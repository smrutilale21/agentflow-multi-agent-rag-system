...
def research_node(state: ResearchState) -> dict:
    ...
    try:
        ...
        research_notes_lower = result.research_notes.lower()

        final_answer_lower = result.final_answer.lower()

        for phrase in weak_phrases:

            if phrase in research_notes_lower or phrase in final_answer_lower:
        ...
        if fallback_required:
            ...
            logger.warning("Weak retrieval detected. " "Using fallback LLM response.")
...
"""
        ...
        return {
            ...
            "final_answer": (
                f"Something went wrong while " f"generating the answer: {e}"
            ),
